...
def test_workflow():
    ...
    test_questions = [
        ...
        "how many people asked for invoices?",
        ...
        # How many questions (testing the new prompts)
        "How many payment issues did we get?",
        "How many people asked to cancel orders?",
        "How many shipping requests that are not address changes?",
        "How many invoice requests and how many account creation requests?",
        "How many contact issues?",
        "How many times does the word 'refund' appear in customer questions?",
        "How many responses contain the phrase 'we apologize'?",
        "How many instructions mention 'delivery' in the text?",
